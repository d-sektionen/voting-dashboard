...
export const postAPI = (endpoint, data) => doRequest(endpoint, { method: 'POST', body: data })

export const updateAPI = (endpoint, data) => doRequest(endpoint, { method: 'PATCH', body: data })
